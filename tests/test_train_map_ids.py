"""Train map ID integrity vs city maps (mirrors pluyencong TRAIN_MAPS)."""

CITY_MAPS = {37, 78, 176, 162, 80, 1, 11}

# Corrected IDs from settings/.../thanhthi.txt
TRAIN_MAPS = [
    {"name": "Ba Lang Huyen", "mapId": 53, "minLv": 1, "maxLv": 20},
...
# Known wrong IDs from earlier buggy table
FORBIDDEN_TRAIN_IDS = {11, 17, 70, 181, 325, 340}
