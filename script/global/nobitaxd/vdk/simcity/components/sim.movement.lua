...
SimMovement.KeoXe = {
    ...
    Move = function(self, simInstance, tbNpc)
        ...
        if tbNpc.isFighting ~= 1 and SimRestoreHorseMovement then
...
SimMovement.Citizen = {
    ...
    Move = function(self, simInstance, tbNpc)
        ...
        -- [STALL FIX 2026-06-19] TT stuck-respawn: bot NGI BN (stall) ng yn 1 ch theo thit k 
        -- b nhm "lag/kt"  respawn sau ~vi pht  dwID i  SP + TIN TC RT (tm theo dwID c ko thy).
        -- Bot kt tht ch ng yn (v hi). Nu cn li stuck-recovery cho bot DI CHUYN, gate theo c stall.
